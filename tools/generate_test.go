...
func (s *GeneratorTestSuite) TestLoadSimplePackage() {
	...
	pkgPath := "github.com/tasdomas/mattermost-plugin-nop/tools/testdata.Simple"
	pkgName, ifaceName, err := parseInterfacePath(pkgPath)
	assert.Nil(t, err)
	assert.Equal(t, "github.com/tasdomas/mattermost-plugin-nop/tools/testdata", pkgName)
...
func (s *GeneratorTestSuite) TestLoadComplexPackage() {
	...
	pkgPath := "github.com/tasdomas/mattermost-plugin-nop/tools/testdata.Complex"
	pkgName, ifaceName, err := parseInterfacePath(pkgPath)
	assert.Nil(t, err)
...
import (
	...
	"github.com/tasdomas/mattermost-plugin-nop/tools/testdata"
)
